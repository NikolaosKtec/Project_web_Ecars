...
public class ProjectWebEcarsApplication {
    ...
    public void init(){
        ...
        List<Prod_automobilis> prod_automobilis = Stream.of(
                    new Prod_automobilis(0l,"Oz-ultraleggera-matt-bronze-5x112","aro e tala 18x8 | matéria prima: Al Si 7 Mg",15236.45,8,"roda.webp",false),
                    new Prod_automobilis(02l,"OZ Ultraleggera Crystal Titanium","desing: 6 Spokes | Duplos matéria prima: Al Si 7 Mg",15236.45,8,"oz_ultraleggera_crystal_titanium.jpg",false),
                    new Prod_automobilis(03l,"Kit Freios Brembo Stage 5 ","Pinças Brembo de 6 Pistões | VW Golf GTI 1.8T / Audi A3 8L 1.8T",36386.00,1,"kit_freios.jpg",false),
